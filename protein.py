...
#==============================================================================
#Credit: https://github.com/mtarbit/Rosalind-Problems/blob/master/e008-prot.py
#==============================================================================
...
print(protein_string('CCCAGUACCGAAAUUAAC'))
print(protein_string('CCAAGUACAGAGAUUAAC'))
print(protein_string('CCCAGGACUGAGAUCAAU'))
print(protein_string('CCGAGGACCGAAAUCAAC'))
